      ...
      <section className="bg-gradient-beast py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-white/90 max-w-2xl mx-auto text-lg">
            We’re stocking the shop! Soon you’ll find custom hoops, bundles,
            apparel, and accessories—everything to fuel your Beast journey.
          </p>
        </div>
      </section>
          ...
          <div className="rounded-2xl border bg-card shadow-lg shadow-beast">
            <div className="p-8 text-center">
              ...
              <p className="text-muted-foreground max-w-xl mx-auto">
                The Products page isn’t ready yet, but it’s in the works. In the meantime,
