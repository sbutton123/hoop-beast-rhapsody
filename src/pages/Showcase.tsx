...
const Showcase = () => {
  const posts = [
    { id: 1, user: "Sarah Beast", location: "Los Angeles, CA", caption: "Just nailed my first double spin! The Beast training is paying off! 🔥", likes: 127, comments: 23, timestamp: "2 hours ago" },
    { id: 2, user: "Mike Thunder", location: "New York, NY", caption: "Flow state achieved! Check out this epic transition sequence", likes: 203, comments: 45, timestamp: "4 hours ago" },
    { id: 3, user: "Luna Goddess", location: "Miami, FL", caption: "Sunset session at the beach. Nothing beats hoop flow by the ocean! 🌊", likes: 89, comments: 12, timestamp: "6 hours ago" },
    { id: 4, user: "Beast Master Alex", location: "Seattle, WA", caption: "Teaching my daughter the art of the hoop. Next generation beast in training!", likes: 156, comments: 34, timestamp: "8 hours ago" },
    { id: 5, user: "Hoop Ninja", location: "Austin, TX", caption: "Core workout complete! 45 minutes of pure beast mode intensity", likes: 94, comments: 18, timestamp: "12 hours ago" },
    { id: 6, user: "Rhythm Queen", location: "Chicago, IL", caption: "Dance fusion flow at its finest. Music + hoop = pure magic ✨", likes: 178, comments: 29, timestamp: "1 day ago" }
  ];
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {posts.map((post) => (
              <Card key={post.id} className="hover-lift shadow-beast">
