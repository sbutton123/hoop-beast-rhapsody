    ...
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-beast overflow-hidden">
      ...
      >
        <img
          ...
          className="w-32 sm:w-48 md:w-64 lg:w-80
                     opacity-90 animate-float delay-500"
        />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="space-y-8">
          ...
          {/* headline */}
          <h1 className="font-bangers
                         text-6xl sm:text-7xl md:text-8xl lg:text-9xl
                         leading-tight">
            UNLEASH YOUR
            <br />

            {/* INNER in black + white drop-shdw */}
            <span
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Button
              size="lg"
              variant="outline"
              className="btn-beast-outline text-lg font-bangers tracking-wide
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8
            ...
            {[
              ...
              <div key={i} className="text-center">
                <div
                  className={`font-bangers text-4xl text-beast-orange
                             animate-float
                             ${i === 1 ? 'delay-500' : ''}
                             ${i === 2 ? 'delay-1000' : ''}`}
                >
