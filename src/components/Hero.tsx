      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="space-y-8">
          ...
          <h1 className="font-bangers text-6xl sm:text-7xl md:text-8xl lg:text-9xl text-white animate-bounce-gentle">
            UNLEASH YOUR
            <br />
            <span className="inline-block text-white text-5xl sm:text-6xl md:text-7xl lg:text-8xl leading-tight">
              INNER&nbsp;
              <span className="text-beast-orange drop-shadow-lg">
                BEAST
              </span>
            </span>
          </h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mt-16 pt-8 border-t border-white/20">
            <div className="text-center">
              <div className="font-bangers text-4xl text-beast-orange animate-float">
                1000+
              </div>
              <div className="text-white/80 font-inter">Beast Transformations</div>
            </div>
            <div className="text-center">
              <div className="font-bangers text-4xl text-beast-orange animate-float delay-500">
                50+
              </div>
              <div className="text-white/80 font-inter">Dynamic Workouts</div>
            </div>
            <div className="text-center">
              <div className="font-bangers text-4xl text-beast-orange animate-float delay-1000">
                24/7
              </div>
