...
const Hero = () => {
  return (
    <section className="relative min-h-screen bg-gradient-beast overflow-hidden">
      {/* top-right logo: hidden on mobile, visible on larger screens */}
      <div className="hidden md:block absolute top-[-110] right-4 sm:top-[-106] sm:right-6 z-30">
      ...
      {/* looping video: positioned below text on mobile */}
      ...
      {/* static PNG on the right: hidden on mobile, positioned properly on larger screens */}
      <div className="hidden sm:block absolute right-4 sm:right-8 md:right-16 lg:right-24 top-[75%] md:top-[60%] transform -translate-y-1/2 z-20">
        <img
      ...
      {/* top text: heading and paragraph, proper spacing for mobile */}
      <div className="relative z-30 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center absolute top-16 sm:top-20 md:top-24">
