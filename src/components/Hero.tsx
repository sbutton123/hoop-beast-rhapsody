...
const Hero = () => {
return ( <section className="relative min-h-screen bg-gradient-beast overflow-hidden">
{/\* subtle pulse grid \*/} <div className="absolute inset-0 opacity-10"> <div
...
```
  ...
  <div className="relative z-30 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 absolute top-16 sm:top-20 md:top-24 flex flex-col items-center md:flex-row md:items-start md:justify-center md:space-x-8">
    {/* Text block */}
    <div className="text-center md:text-left md:max-w-lg">
      ...
      <div className="mt-8 flex justify-center md:justify-start">
        <img
          src="/lovable-uploads/aa66bb76-9e6a-0edda4d38cba.png"
